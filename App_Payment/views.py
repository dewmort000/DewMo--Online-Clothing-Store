...
def payment(request):
    ...
    store_id = 'easys61277505db6b2'
    API_key = 'easys61277505db6b2@ssl'
...
def complete(request):
    if request.method == 'POST' or request.method == 'post':
        ...
        if status == 'VALID':
            ...
            messages.warning(request, f"Your Payment Failed! Please Try Again! This page will redirected to homepage")
